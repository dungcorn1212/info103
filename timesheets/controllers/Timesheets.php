			...
			if ($this->input->post()) {
				...
				foreach ($rResult as $aRow) {
					...
					if (has_permission('table_shiftwork_management', '', 'view') || is_admin()) {
						...
						$option .= '<i class="fa-solid fa-pen-to-square"></i>';
						$option .= '</a>';
			...
			if ($this->input->post()) {
				...
				foreach ($rResult as $aRow) {
					...
					if (is_admin()) {
						...
						data-position="' . html_entity_decode($aRow['position']) . '" class="btn btn-default btn-icon" data-toggle="sidebar-right" data-target=".leave_modal_update-edit-modal"><i class="fa-solid fa-pen-to-square"></i></a>
