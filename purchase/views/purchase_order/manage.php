                       ...
                       <div class="col-md-3 form-group">
                        <label for="type"><?php echo _l('coso_ducna'); ?></label>
                         <select name="type[]" id="type" class="selectpicker" multiple="true"  data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('leads_all'); ?>">
                           <option value="68-72 Tây Mỗ" ><?php echo _l('6872_taymo'); ?></option>
                           <option value="184 Trần Duy Hưng" ><?php echo _l('184_tran_duy_hung'); ?></option>
                           <option value="AHIB - C5 Techcombank" ><?php echo _l('ahib_c5teccombank'); ?></option>
                           <option value="AHIB - Bắc Ninh" ><?php echo _l('ahib_bacninh'); ?></option> 
                           <option value="AHIB - HCM" ><?php echo _l('ahib_hochiminh'); ?></option>
                           <option value="AHIB - HCM" ><?php echo _l('drhan_laichau'); ?></option>
                           <option value="Dragon Tea- Suối Giàng" ><?php echo _l('suoi_giang'); ?></option>
                        </select>
                       </div>
