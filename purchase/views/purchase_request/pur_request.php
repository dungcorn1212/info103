                ...
                <div class="row accounting-template">
                  ...
                  <div class="row ">
                    <div class="col-md-12">
                      ...
                      <?php $pur_rq_code = ( isset($pur_request) ? $pur_request->pur_rq_code : $prefix.'-'.str_pad($next_number,5,'0',STR_PAD_LEFT).'-'.date('mY'));
                      ...
                      <label for="requester"><?php echo _l('requester'); ?></label>
                        <select name="requester" id="requester" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                          ...
                          <?php foreach($staffs as $s) { ?>
                            <option value="<?php echo pur_html_entity_decode($s['staffid']); ?>" <?php if(isset($pur_request) && $s['staffid'] == $pur_request->requester){ echo 'selected'; }elseif($s['staffid'] == get_staff_user_id()){ echo 'selected'; } ?>>
                              <!-- <?php echo pur_html_entity_decode($s['lastname'] . ' '. $s['firstname']); ?></option> -->
                              <?php echo pur_html_entity_decode($s['firstname'] . ' '. $s['lastname']); ?></option>
                    ...
                    <!--  <div class="row ">
                      <div class="col-md-12">
                        ...
                        <!-- <div class="col-md-3 form-group">
                          ...
                          <div class="col-md-3 form-group">
                            <label for="type"><?php echo _l('coso_ducna'); ?></label>
                              <select name="type" id="type" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">


                                <option value="68-72 Tây Mỗ" <?php if(isset($pur_request) && $pur_request->type == 'coso_ducna'){ echo 'selected';} ?>><?php echo _l('6872_taymo'); ?></option>
                                <option value="184 Trần Duy Hưng" <?php if(isset($pur_request) && $pur_request->type == 'coso_ducna'){ echo 'selected';} ?>><?php echo _l('184_tran_duy_hung'); ?></option>
                                <option value="AHIB - C5 Techcombank" <?php if(isset($pur_request) && $pur_request->type == 'coso_ducna'){ echo 'selected';} ?>><?php echo _l('ahib_c5teccombank'); ?></option>
                                <option value="AHIB - Bắc Ninh" <?php if(isset($pur_request) && $pur_request->type == 'coso_ducna'){ echo 'selected';} ?>><?php echo _l('ahib_bacninh'); ?></option>
                                <option value="AHIB - HCM" <?php if(isset($pur_request) && $pur_request->type == 'coso_ducna'){ echo 'selected';} ?>><?php echo _l('ahib_hochiminh'); ?></option>
                                <option value="Dr. Han Hospital Lai Châu" <?php if(isset($pur_request) && $pur_request->type == 'coso_ducna'){ echo 'selected';} ?>><?php echo _l('drhan_laichau'); ?></option>
                                <option value="Dragon Tea- Suối Giàng" <?php if(isset($pur_request) && $pur_request->type == 'coso_ducna'){ echo 'selected';} ?>><?php echo _l('suoi_giang'); ?></option>
                              </select>
                              <br><br>
                          </div>
                  ...
                  <div class="col-md-12">
                      <?php 
                      $rq_description = (isset($pur_request) ? $pur_request->rq_description : '');
                      echo render_textarea('rq_description', 'rq_description', $rq_description, ['rows' => 10], [], '', 'tinymce'); 
                      ?>
                  </div>
                        ...
                        <table class="table invoice-items-table items table-main-invoice-edit has-calculations no-mtop">
                          <thead>
                            <tr>
                              ...
                              <th width="15%" align="right">Nhà cung cấp</th>
