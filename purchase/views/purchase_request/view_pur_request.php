         ...
         <div class="col-md-12">
                    ...
                    <div class="horizontal-scrollable-tabs preview-tabs-top">
                      ...
                      <div class="horizontal-tabs">
                         <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                            ...
                            </li> an chuc nang so sanh bao gia -->
            ...
            ?></td>
                       ...
                       <tr class="project-overview">
                          ...
                          <td><?php echo pur_html_entity_decode(($map_departments[$pur_request->department]['name'] ?? ''));?></td>
                       </tr>
                       <tr class="project-overview">
                          <td class="bold"><?php echo _l('type'); ?></td>
                          <td><?php echo _l($pur_request->type); ?></td>
                       </tr>
                       <tr class="project-overview">
                       ...
                       <tr>
                        <td class="bold"><?php echo _l('xem_pdf'); ?></td>
...
foreach($pur_request_detail as $es) { 
   $_subtotal += floor($es['into_money']);
   $_total += floor($es['total']);
 ?>
<tr nobr="true" class="sortable">
   ...
   ?>
   <td align="right"  width="15%"><?php echo $es['supplier'] ?></td>
   <td align="right"  width="12%"><?php echo pur_html_entity_decode($es['quantity']). ' '.$unit_name; ?></td>
   <td align="right"><?php echo app_format_money(floor($es['unit_price']), $base_currency->symbol); ?></td>
   <td align="right"><?php echo app_format_money(floor($es['into_money']), $base_currency->symbol); ?></td>
   <td align="right"><?php 
   if($es['tax_name'] != ''){
   ...
   ?></td>
   <td align="right"><?php echo app_format_money(floor($es['tax_value']), $base_currency->symbol); ?></td>

   <td class="amount" align="right"><?php echo app_format_money(floor($es['total']), $base_currency->symbol); ?></td>
</tr>
<?php 
...
<tr id="subtotal">
   ...
   <td width="65%" id="total_td">
     ...
     <?php echo app_format_money(floor($_subtotal), $base_currency->symbol); ?>
   </td>
</tr>
</tbody>
</table>
...
<tr id="total">
   ...
   <td width="65%" id="total_td">
     <?php echo app_format_money(floor($_total), $base_currency->symbol); ?>
   </td>
</tr>
</tbody>
</table>
    ...
    <div class="col-md-12 project-overview-expenses-finance">
        ...
        ?>
            <div class="col-md-3 apr_div">
                <?php if ($title_index < count($titles)): ?>
                    <h4 class="text-center" style="margin-bottom: 10px; font-weight: bold;">
                        <?php echo htmlspecialchars($titles[$title_index]); $title_index++; ?>
                    </h4>
                <?php endif; ?>
            ...
            <div class="col-md-3 apr_div">
                ...
                <p class="text-uppercase text-muted no-mtop bold">
                    ...
                    foreach ($value['staffid'] as $key => $val) {
                        ...
                        $staff_info = $this->staff_model->get($val);
                        $staff_name .= isset($staff_info->firstname) ? $staff_info->firstname : '';
                        $staff_name .= isset($staff_info->lastname) ? ' ' . $staff_info->lastname : '';
                    }
                    echo pur_html_entity_decode($staff_name); 
                    ?>
                </p>
...
<?php } ?>
                ...
                <div role="tabpanel" class="tab-pane ptop10 " id="compare_quotes">
                  ...
                  ?></td>
                              ...
                              <tr class="project-overview">
                             <td class="bold"><?php echo _l('department'); ?></td>
                                 <td><?php echo pur_html_entity_decode($dpm_name); ?></td>
                             </tr>
                             <tr class="project-overview">
                                <td class="bold"><?php echo _l('request_date'); ?></td>
                                <td><?php echo _dt($pur_request->request_date); ?></td>
