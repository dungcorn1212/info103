...
class purchase extends AdminController
{
    ...
    public function view_pur_request($id){
		...
		$data['departments'] = $this->departments_model->get();
        $data['map_departments'] =$this->purchase_model->mapDepartmentsWithKey($data['departments']);
    	$data['units'] = $this->purchase_model->get_units();
...
/**
    ...
    public function get_purchase_request_row_template(){
        ...
        echo $this->purchase_model->create_purchase_request_row_template( $name, $item_code, $item_text, $unit_price, $quantity, $unit_name, $unit_id, $into_money, $item_key, $tax_value, $total, $tax_name, '', '', false, $currency_rate, $to_currency, $supplier);
    }
