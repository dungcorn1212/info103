                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <?php echo form_close(); ?>
 <div class="gioi-thieu-tuyen-dung">                               
<span style="margin-left: 1em;"><b>Tập Đoàn HYH Việt Nam</b></span> được xây dựng với nền tảng ban đầu là doanh nghiệp hoạt động trong lĩnh vực y tế đa khoa. Trải qua 4 giai đoạn phát triển tính từ 2005 tới nay, công ty đã mở rộng và phát triển thêm đa ngành nghề và năm 2019 chính thức sát nhập các công ty thành viên thành một quần thể lớn mạnh hoạt động dưới mô hình Tập đoàn. Điều này đã chứng tỏ sự thành công vượt bậc của đội ngũ lãnh đạo cùng toàn bộ nhân sự bên trong bộ máy. <br>
<span style="margin-left: 1em;">Trải qua nhiều năm hoạt động và phát triển không ngừng,</span> Tập đoàn HYH Việt Nam đã tạo dựng được vị thế và danh tiếng của mình trong nền kinh tế của Quốc Gia. Tại HYH, chúng tôi luôn xây dựng định hướng phát triển theo mục tiêu rõ ràng, lấy giá trị cốt lõi “Tín – Tâm – Chất – Nhân” lên hàng đầu. Tài sản quý giá nhất của doanh nghiệp chính là sự hài lòng, tin cậy của Quý khách hàng.
</div>
                            </div>
                        </div>
                    </div>
