    ...
    <?php foreach ($list_form as $lf) {?>
    	<tr>
    		...
    		<td>
	            ...
	            <a href="#" onclick="edit_evaluation_form(this,<?php echo html_entity_decode($lf['form_id']); ?>); return false;" data-form_name="<?php echo html_entity_decode($lf['form_name']); ?>" data-position="<?php echo html_entity_decode($lf['position']); ?>"  class="btn btn-default btn-icon"><i class="fas fa-pencil-alt"></i>
	            </a>
	            <?php }?>
