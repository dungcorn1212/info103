...
<table class="table dt-table">
 ...
 <tbody>
    ...
    <tr>
       ...
       <td>
         <a href="#" onclick="edit_skill(this,<?php echo html_entity_decode($skill['id']); ?>); return false" data-name="<?php echo html_entity_decode($skill['skill_name']); ?>" class="btn btn-default btn-icon"><i class="fas fa-pencil-alt"></i></a>
