...
<table class="table dt-table">
 ...
 <tbody>
    ...
    <tr>
       ...
       <td>
         <a href="#" onclick="edit_industry(this,<?php echo html_entity_decode($industry['id']); ?>); return false" data-name="<?php echo html_entity_decode($industry['industry_name']); ?>" class="btn btn-default btn-icon"><i class="fas fa-pencil-alt"></i></a>
