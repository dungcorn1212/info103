 ...
 <tbody>
	...
	?>
        ...
        <td>
            ...
            <a href="#" onclick="edit_evaluation_criteria(this,<?php echo html_entity_decode($gr['criteria_id']); ?>); return false;" data-criteria_title="<?php echo html_entity_decode($gr['criteria_title']); ?>" data-criteria_type="<?php echo html_entity_decode($gr['criteria_type']); ?>" data-description="<?php echo html_entity_decode($gr['description']); ?>" data-group_criteria="<?php echo html_entity_decode($gr['group_criteria']); ?>" data-score_des1="<?php echo html_entity_decode($gr['score_des1']); ?>" data-score_des2="<?php echo html_entity_decode($gr['score_des2']); ?>" data-score_des3="<?php echo html_entity_decode($gr['score_des3']); ?>" data-score_des4="<?php echo html_entity_decode($gr['score_des4']); ?>" data-score_des5="<?php echo html_entity_decode($gr['score_des5']); ?>" class="btn btn-default btn-icon"><i class="fas fa-pencil-alt"></i>
            </a>
            <?php }?>
