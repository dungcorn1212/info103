...
<table class="table dt-table">
 ...
 <tbody>
    ...
    <tr>
       ...
       <td>
         <a href="#" onclick="edit_company(this,<?php echo html_entity_decode($company['id']); ?>); return false" data-name="<?php echo html_entity_decode($company['company_name']); ?>" data-address="<?php echo html_entity_decode($company['company_address']); ?>" data-industry="<?php echo html_entity_decode($company['company_industry']); ?>" class="btn btn-default btn-icon"><i class="fas fa-pencil-alt"></i></a>
