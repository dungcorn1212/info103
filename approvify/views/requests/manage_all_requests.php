...
$('select[name="approvify_request_status"], select[name="approvify_request_staff"], select[name="approvify_approval_categories"], select[name="approvify_last_reviewer"], select[name="approvify_next_reviewer"], input[name="approvify_date_from"], input[name="approvify_date_to"]').on('change', function () {
        generate_table();
    });
    ...
    $('#toggleFilters').on('click', function() {
        ...
        $(this).text(function(i, text){
            return text === "<?php echo _l('show_filters'); ?>" ? "<?php echo _l('show_filters'); ?>" : "<?php echo _l('hide_filters'); ?>";
        });
    });
});
