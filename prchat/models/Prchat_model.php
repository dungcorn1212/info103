...
class Prchat_model extends App_Model
{
    ...
    public function get_shared_files_and_create_template($own_id, $contact_id)
    {
        ...
        $html .= '<li class="active"><a href="#photos" role="tab" data-toggle="tab"><i class="fas fa-paperclip icon_shared_files" aria-hidden="true"></i>' . _l('chat_photos_text') . '</a></li>';
    ...
    public function get_group_shared_files_and_create_template($group_id)
    {
        ...
        $html = '';
        $html .= '<ul class="nav nav-tabs" role="tablist">';
        $html .= '<li class="active"><a href="#group_photos" role="tab" data-toggle="tab"><i class="fas fa-paperclip icon_shared_files" aria-hidden="true"></i>' . _l('chat_photos_text') . '</a></li>';
