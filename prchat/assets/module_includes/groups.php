        ...
        groupChannels.bind("member-left-channel", function (data) {
            ...
            if (data.member_id == userSessionId) {
                ...
                if (selector.remove()) {
                    ...
                    alert_float("info",'<?php echo _l("chat_group_left_text"); ?>' + '<?php echo _l("chat_group_text"); ?>' + group_name + '<?php echo _l("chat_group_left_text_success"); ?>');
                }
            } else if (data.member_id !== userSessionId || isAdmin) {
                alert_float("info", "nhan_su_chat" + data.user_full_name + "da_roi_khoi_nhom" + group_name);
